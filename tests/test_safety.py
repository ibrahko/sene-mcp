...
@pytest.mark.parametrize(
    ...
    [
        ...
        "Diluer 20 ml dans 15 litres d'eau",
        "20 ml de produit pour 15 litres",
        "250 g à l'hectare",
        "1 l à l'ha",
        "un demi-litre par hectare",
        "Diluer 30 ml du produit dans 15 l",
        "3 cuillères à soupe par pompe",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "Utiliser un bidon de 20 l pour l'eau",
        "Arracher les plants au stade 2-4 d'feuilles",
        "entre 2/4 de la hauteur de la tige",
        "Préserver les ennemis naturels comme les coccinelles",
        TREATMENT_GUIDANCE,
    ],
)
